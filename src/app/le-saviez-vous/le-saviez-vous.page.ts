...
@Component({
  selector: 'app-le-saviez-vous',
  templateUrl: './le-saviez-vous.page.html',
  styleUrls: ['./le-saviez-vous.page.scss'],
})
export class LeSaviezVousPage {

	categories: Array<Category>;
	questions: Array<Question>;

	current_page: string = "Le saviez-vous ?";
	router: string;
	screen_width: number;
	menu: boolean = false;
