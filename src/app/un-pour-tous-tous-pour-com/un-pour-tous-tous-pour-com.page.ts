...
@Component({
  selector: 'app-un-pour-tous-tous-pour-com',
  templateUrl: './un-pour-tous-tous-pour-com.page.html',
  styleUrls: ['./un-pour-tous-tous-pour-com.page.scss'],
})
export class UnPourTousTousPourComPage {

	categories: Array<Category>;
	folders: Array<Folder>;

	current_page: string = "Un pour tous, tous pour com";
	router: string;
	screen_width: number;
	menu: boolean = false;
