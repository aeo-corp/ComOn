...
@Component({
  selector: 'app-com-un-air-de-news',
  templateUrl: './com-un-air-de-news.page.html',
  styleUrls: ['./com-un-air-de-news.page.scss'],
})
export class ComUnAirDeNewsPage {

	categories: Array<Category>;
	news: Array<New>;

	current_page: string = "Com' un air de news";
	router: string;
	screen_width: number;
	menu: boolean = false;
